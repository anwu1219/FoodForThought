...
class SustainabilityInfoViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        var y: CGFloat = 0.0
        testView.backgroundColor = UIColor(red: 0.6, green: 0.78, blue: 0.6, alpha: 1.0)
        testView.layer.borderColor = UIColor(red: 0.1, green: 0.35, blue: 0.1, alpha: 1.0).CGColor
        ...
        for var i = 0; i < 3; i++ {
            ...
            button.frame = CGRectMake(testView.frame.width*0.2, y, testView.frame.width*0.6, 50)
